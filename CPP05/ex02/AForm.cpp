...
const char *Form::FormNotSignedExceptiom::what() const throw()
{
    return ("Form : Exception, Form Not Signed!");
}

const char *Form::FormCanNotOpenFileException::what() const throw()
{
    return ("Form : Exception, Form Can Not Open File!");
}

const char *Form::FormCanNotWriteOnFile::what() const throw()
{
